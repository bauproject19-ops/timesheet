...
ALL_REMINDER_USER_IDS = [951, 257, 787, 249, 399]

# Пока катаем и проверяем автоматизацию только на Денисе (id=5) — без
# привлечения остальных сотрудников. Когда всё стабильно отработает без
# ручного участия, переключить TEST_MODE на False, чтобы напоминалка
# вернулась на реальный список сотрудников (ALL_REMINDER_USER_IDS).
TEST_MODE = True
REMINDER_USER_IDS = [5] if TEST_MODE else ALL_REMINDER_USER_IDS
